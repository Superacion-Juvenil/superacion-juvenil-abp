...
//
// El original NO carga este script en unete.html ni en aviso.html, así que en
// esas páginas el menú se abre igual mostrando el panel (es puro CSS del
// checkbox) pero nunca bloquea el scroll. Se replica ese estado a propósito:
// iniciarMenu() solo se invoca desde index.astro, nosotros.astro y
// proyectos.astro, que son las páginas que hoy cargan menu.js. Cambiar eso es
// una decisión aparte, no de esta tarea.
